...
{
    public static Task<Result> DomainCommandAsync(string failureType) { return Task.FromResult(DomainCommand(failureType)); }
    ...
    public static Task<Result<int>> DomainQueryAsync(string failureType) { return Task.FromResult(DomainQuery(failureType)); }
