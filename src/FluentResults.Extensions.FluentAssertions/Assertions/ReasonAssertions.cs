...
namespace SlugEnt.FluentResults.Extensions.FluentAssertions
{
    public class ReasonAssertions : ReferenceTypeAssertions<IReason, ReasonAssertions>
    {
        ...
        public AndWhichConstraint<ReasonAssertions, IReason> HaveMetadata(string metadataKey,
        ...
        public AndWhichConstraint<ReasonAssertions, IReason> Satisfy<TReason>(Action<TReason> action)
            where TReason : class, IReason
        {
