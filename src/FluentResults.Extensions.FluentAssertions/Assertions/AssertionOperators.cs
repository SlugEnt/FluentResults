...
namespace SlugEnt.FluentResults.Extensions.FluentAssertions
{
    ...
    {
        public AndWhichConstraint<TResultAssertion, TResult> Do<TResultAssertion, TResult>(TResult subject,
            TResultAssertion parentConstraint,
            string because,
    ...
    {
        public AndWhichThatConstraint<TResultAssertion, TResult, ReasonAssertions> Do<TResultAssertion, TResult>(TResult subject,
            TResultAssertion parentConstraint,
            string expectedMessage,
            Func<string, string, bool> messageComparison,
            string because,
            params object[] becauseArgs)
            where TResult : ResultBase
        {
            ...
            Execute.Assertion
                   ...
                   .FailWith("Expected result to contain reason with message containing {0}, but found reasons '{1}'",
                             expectedMessage, subject.Reasons);

            return new AndWhichThatConstraint<TResultAssertion, TResult, ReasonAssertions>(parentConstraint, subject,
                 new ReasonAssertions(subject.Reasons.SingleOrDefault(reason => messageComparison(reason.Message,
                                                                           expectedMessage))));
        }
    }
    ...
    internal class HaveErrorAssertionOperator
    {
            ...
            where TResult : ResultBase
        {
            ...
            Execute.Assertion
                   ...
                   .FailWith("Expected result to contain error with message containing {0}, but found error '{1}'",
                             expectedMessage, subject.Errors);
    ...
    {
        public AndWhichThatConstraint<TResultAssertion, TResult, ReasonAssertions> Do<TResultAssertion, TResult, TReason>(
            TResult subject,
            TResultAssertion parentConstraint,
            string expectedMessage,
            Func<string, string, bool> messageComparison,
            ...
            where TReason : IReason
        {
            ...
            Execute.Assertion
                   ...
                   .ForCondition(reasons => reasons.Any(reason => messageComparison(reason.Message, expectedMessage)))
                   .FailWith("Expected result to contain reason of type {0} with message containing {1}, but found reasons '{2}'",
                             typeof(TReason).Name, expectedMessage, subject.Reasons);
    ...
    {
        public AndConstraint<TResultAssertion> Do<T, TResultAssertion>(Result<T> subject,
                                                                       TResultAssertion parentConstraint,
                                                                       T expectedValue,
                                                                       string because,
                                                                       params object[] becauseArgs)
